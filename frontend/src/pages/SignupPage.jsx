    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-dark px-4">
      ...
      <div className="relative w-full max-w-sm animate-slide-up">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm mt-1">Start tracking prices with PriceIQ</p>
        </div>
        ...
        <div className="card">
          <form onSubmit={handleSubmit} className="space-y-4" id="signup-form">
            <div>
              <label htmlFor="signup-email" className="block text-xs font-semibold text-gray-400 mb-1.5 uppercase tracking-wider">
                Email
              </label>
              <input
                id="signup-email"
            ...
            <div>
              <label htmlFor="signup-password" className="block text-xs font-semibold text-gray-400 mb-1.5 uppercase tracking-wider">
                Password
              </label>
              <input
                id="signup-password"
            ...
            <div>
              <label htmlFor="confirm-password" className="block text-xs font-semibold text-gray-400 mb-1.5 uppercase tracking-wider">
                Confirm Password
              </label>
              <input
                id="confirm-password"
